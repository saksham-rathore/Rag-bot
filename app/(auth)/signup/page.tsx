...
export default function SignUp() {
  ...
  // Sign up form
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-950 text-neutral-100 relative overflow-hidden px-4 py-10">
      {/* Background glow */}
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 sm:p-10 w-full max-w-[460px] shadow-2xl z-10">
        ...
        <p className="text-neutral-400 text-sm mb-8">Sign up to start your conversation with knowledge.</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="name" className="text-neutral-500 text-xs font-bold tracking-widest uppercase">
              Full Name
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-neutral-800 border border-neutral-700 rounded-xl py-3 pl-10 pr-4 text-neutral-100 text-sm focus:outline-none focus:border-indigo-500/50 transition-all placeholder:text-neutral-600"
      ...
      <p className="text-neutral-700 text-xs mt-6 z-10">By signing up you agree to our Terms and Privacy.</p>
    </div>
  );
}
