      ...
      <div className="bg-[#0f0f0f]/80 backdrop-blur-xl border border-zinc-800/80 rounded-[2rem] p-8 sm:p-12 w-full max-w-[480px] shadow-[0_0_50px_rgba(0,0,0,0.5)] relative z-10"
        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-4 mb-8">
            <button type="button" className="flex-1 bg-[#141414] hover:bg-[#1f1f1f] border border-zinc-800 rounded-2xl py-3 px-4 flex items-center justify-center gap-2.5 text-[#e4e4e7] text-sm font-semibold transition-colors">
