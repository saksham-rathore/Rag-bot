  ...
  if (status === "loading") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] font-sans">
        <div className="text-amber-500 animate-pulse font-serif text-2xl">Loading...</div>
      </div>
    );
  }
        ...
        <div className="bg-[#0f0f0f]/90 backdrop-blur-xl border border-zinc-800/80 rounded-[2rem] p-10 w-full max-w-[480px] shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden z-10"
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            ...
            <div className="text-center">
              <h1 className="text-white text-3xl font-serif font-bold tracking-tight mb-2">Welcome Back</h1>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0a0a0a] font-sans relative overflow-hidden px-4">
      ...
      <div className="flex items-center gap-3 mb-10 z-10">
        <div className="w-12 h-12 rounded-full bg-black border border-zinc-800 flex items-center justify-center shadow-lg">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fcd34d" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 2L2 7l10 5 10-5-10-5z" />
            <path d="M2 17l10 5 10-5" />
            <path d="M2 12l10 5 10-5" />
          </svg>
        </div>
        <span className="text-white text-3xl font-serif tracking-wide font-bold">Lexora<span className="text-zinc-200">.AI</span></span>
      </div>
      ...
      <div className="bg-[#0f0f0f]/80 backdrop-blur-xl border border-zinc-800/80 rounded-[2rem] p-8 sm:p-12 w-full max-w-[480px] shadow-[0_0_50px_rgba(0,0,0,0.5)] relative z-10"
        ...
        <div className="relative z-10">
          ...
          <p className="text-[#a1a1aa] text-center text-[15px] mb-8 font-medium">Sign in to continue your conversation with knowledge.</p>
          ...
          <div className="flex gap-4 mb-8">
            <button type="button" className="flex-1 bg-[#141414] hover:bg-[#1f1f1f] border border-zinc-800 rounded-2xl py-3 px-4 flex items-center justify-center gap-2.5 text-[#e4e4e7] text-sm font-semibold transition-colors" onClick={() => signIn("google")}>
            ...
            <button type="button" className="flex-1 bg-[#141414] hover:bg-[#1f1f1f] border border-zinc-800 rounded-2xl py-3 px-4 flex items-center justify-center gap-2.5 text-[#e4e4e7] text-sm font-semibold transition-colors" onClick={() => signIn("github")}>
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-[#71717a] text-[11px] font-bold tracking-[0.15em] uppercase">Or with email</span>
            <div className="h-[1px] flex-1 bg-gradient-to-l from-transparent via-zinc-800 to-zinc-700"></div>
          </div>

          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2.5">
              <label htmlFor="email" className="text-[#a1a1aa] text-[11px] font-bold tracking-[0.1em] uppercase ml-1">Email</label>
            ...
            <div className="flex flex-col gap-2.5">
              <label htmlFor="password" className="text-[#a1a1aa] text-[11px] font-bold tracking-[0.1em] uppercase ml-1">Password</label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-500">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex items-center justify-between mt-1 mb-2">
              <label className="flex items-center gap-2 cursor-pointer group">
                <div 
                  className={`w-[18px] h-[18px] rounded flex items-center justify-center transition-colors ${
                    rememberMe ? 'bg-[#fcd34d]' : 'bg-[#121212] border border-zinc-700 group-hover:border-zinc-500'
                  }`}
              ...
              <button type="button" className="text-[#a1a1aa] hover:text-[#e4e4e7] text-[13px] transition-colors">
                Forgot password?
              </button>
            </div>
          ...
          <div className="text-center mt-8">
            ...
            <button type="button" className="text-[#fbbf24] hover:text-[#fcd34d] text-sm font-semibold transition-colors">
              Create an account
            </button>
          </div>
        </div>
